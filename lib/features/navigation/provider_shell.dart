...
class ProviderShell extends StatelessWidget {
  ...
  int _index(BuildContext context) {
    ...
    if (loc.startsWith('/provider/requests')) return 1;
    if (loc.startsWith('/provider/messages')) return 2;
    if (loc.startsWith('/provider/profile'))  return 3;
    return 0;
  }
  ...
  Widget build(BuildContext context) {
    ...
    final items = [
      (Icons.home_repair_service_rounded, l.navHome),
      (Icons.list_alt_rounded,            l.navRequests),
